...
function setupGracefulShutdown(server) {
  const shutdown = (signal) => {
    const signalInfo = {
      ...
      processGroup: typeof process.getpgid === 'function' ? process.getpgid(process.pid) : 'unknown',
      ...
      userId: typeof process.getuid === 'function' ? process.getuid() : 'unknown',
      groupId: typeof process.getgid === 'function' ? process.getgid() : 'unknown',
